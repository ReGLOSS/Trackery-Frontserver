...
document.addEventListener("DOMContentLoaded", async function () {
    try {
        await loadModal("/register/modal-html", document.getElementById("register-modal-container"), "/register/js/register.js");
        await loadModal("/login/login-modal-html", document.getElementById("login-modal-container"), "/login/js/login.js");
        await loadModal("/login/find-account-modal-html", document.getElementById("find-account-modal-container"), "/login/js/find-account.js");
